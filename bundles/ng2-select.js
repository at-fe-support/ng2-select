...
System.registerDynamic("ng2-select/components/select/select", ["@angular/core", "./select-item", "./select-pipes", "./common"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
  ...
  var SelectComponent = (function() {
      ...
      set: function(value) {
        ...
        if (!value) {
          ...
          this._items = value.filter(function(item) {
            if ((typeof item === 'string' && item) || (typeof item === 'object' && item && item[_this.textField] && item[_this.idField])) {
              return item;
            }
          });
    ...
    SelectComponent.prototype.isActive = function(value) {
      return this.activeOption.id === value.id || this.activeOption.text === value.text;
    };
    ...
    SelectComponent.prototype.checkOutsideClicked = function(event) {
    ...
    __decorate([core_1.Input(), __metadata('design:type', String)], SelectComponent.prototype, "childrenField", void 0);
